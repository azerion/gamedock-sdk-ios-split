...
-(void)processPlayerData:(Wallet*)updatedWallet withInventory:(Inventory*)updatedInventory  fromRequestUserData:(BOOL)fromRequestUserData;
-(void)alignOffsets:(Wallet*)updatedWallet withInventory:(Inventory*)updatedInventory;
-(void)setPlayerDataWithWallet:(Wallet*)updatedWallet withInventory:(Inventory*)updatedInventory;
