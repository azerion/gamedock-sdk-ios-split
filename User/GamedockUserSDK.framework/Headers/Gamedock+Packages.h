...
// yoo2 +(nullable Container*)getMissionContainer:(nonnull NSString*)containerId;
...
// yoo2 +(nullable Mission*)getMissionConfiguration:(nonnull NSString*)missionId;
 ...
 * returns if there is a promotion
 */
// yoo +(BOOL)hasActiveEntryPromotion:(nonnull ShopEntry*)shopEntry;
